...
enum BURN_EXE_PACKAGE_EXECUTION_MODE
{
    BURN_EXE_PACKAGE_EXECUTION_MODE_NONE,
    BURN_EXE_PACKAGE_EXECUTION_MODE_SYNCHRONOUS,
    BURN_EXE_PACKAGE_EXECUTION_MODE_ASYNCHRONOUS,
    BURN_EXE_PACKAGE_EXECUTION_MODE_FIRE_AND_FORGET,
};
...
typedef struct _BURN_EXECUTE_ACTION
{
    ...
    union
    {
        ...
        {
            BURN_PACKAGE* pPackage;
            BURN_EXE_PACKAGE_EXECUTION_MODE executionMode;
