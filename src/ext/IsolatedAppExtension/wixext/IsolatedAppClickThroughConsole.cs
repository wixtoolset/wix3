//-------------------------------------------------------------------------------------------------
// <copyright file="IsolatedAppClickThroughConsole.cs" company="Outercurve Foundation">
...
// 
// <summary>
// Isolated application ClickThrough console extension.
// </summary>
//-------------------------------------------------------------------------------------------------
...
namespace Microsoft.Tools.WindowsInstallerXml.Extensions
{
    ...
    /// </summary>
    public sealed class IsolatedAppClickThroughConsole : ClickThroughConsoleExtension
    {
        ...
        public override CommandLineOption[] CommandLineTypes
        {
            get
            {
                ...
                {
                    new CommandLineOption("isolatedapp", "build an Isolated Application", 0),
