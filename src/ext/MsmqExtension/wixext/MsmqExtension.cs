//-------------------------------------------------------------------------------------------------
// <copyright file="MsmqExtension.cs" company="Outercurve Foundation">
...
// 
// <summary>
// The Windows Installer XML Toolset MSMQ Extension.
// </summary>
//-------------------------------------------------------------------------------------------------
...
namespace Microsoft.Tools.WindowsInstallerXml.Extensions
{
    ...
    /// The Windows Installer XML Toolset MSMQ Extension.
    /// </summary>
    public sealed class MsmqExtension : WixExtension
    {
        private Library library;
        private MsmqCompiler compilerExtension;
        private MsmqDecompiler decompilerExtension;
        ...
        public override CompilerExtension CompilerExtension
        {
            get
            {
                ...
                {
                    this.compilerExtension = new MsmqCompiler();
                }
        ...
        public override DecompilerExtension DecompilerExtension
        {
            get
            {
                ...
                {
                    this.decompilerExtension = new MsmqDecompiler();
                }
        ...
        public override Library GetLibrary(TableDefinitionCollection tableDefinitions)
        {
            ...
            {
                this.library = LoadLibraryHelper(Assembly.GetExecutingAssembly(), "Microsoft.Tools.WindowsInstallerXml.Extensions.Data.msmq.wixlib", tableDefinitions);
            }
