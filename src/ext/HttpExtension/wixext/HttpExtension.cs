//-------------------------------------------------------------------------------------------------
// <copyright file="HttpExtension.cs" company="Outercurve Foundation">
...
namespace Microsoft.Tools.WindowsInstallerXml.Extensions
{
    ...
    /// <summary>
    /// The Windows Installer XML Toolset Http Extension.
    /// </summary>
    public sealed class HttpExtension : WixExtension
    {
        private HttpCompiler compilerExtension;
        private HttpDecompiler decompilerExtension;
        ...
        public override CompilerExtension CompilerExtension
        {
            get
            {
                ...
                {
                    this.compilerExtension = new HttpCompiler();
                }
        ...
        public override DecompilerExtension DecompilerExtension
        {
            get
            {
                ...
                {
                    this.decompilerExtension = new HttpDecompiler();
                }
        ...
        public override Library GetLibrary(TableDefinitionCollection tableDefinitions)
        {
            ...
            {
                this.library = LoadLibraryHelper(Assembly.GetExecutingAssembly(), "Microsoft.Tools.WindowsInstallerXml.Extensions.Data.http.wixlib", tableDefinitions);
            }
