    ...
    )
{
    ...
    hr = CreateBootstrapperApplication(vhInstance, FALSE, NULL, pEngine, pCommand, ppApplication);
    ...
    )
{
    ...
    hr = CreateBootstrapperApplication(vhInstance, TRUE, wzFailedMessage, pEngine, pCommand, ppApplication);
