//-------------------------------------------------------------------------------------------------
// <copyright file="GamingExtension.cs" company="Outercurve Foundation">
...
namespace Microsoft.Tools.WindowsInstallerXml.Extensions
{
    ...
    {
        private GamingCompiler compilerExtension;
        private GamingDecompiler decompilerExtension;
        ...
        public override CompilerExtension CompilerExtension
        {
            get
            {
                ...
                {
                    this.compilerExtension = new GamingCompiler();
                }
        ...
        public override DecompilerExtension DecompilerExtension
        {
            get
            {
                ...
                {
                    this.decompilerExtension = new GamingDecompiler();
                }
