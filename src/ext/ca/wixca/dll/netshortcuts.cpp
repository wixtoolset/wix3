//-------------------------------------------------------------------------------------------------
// <copyright file="netshortcuts.cpp" company="Outercurve Foundation">
...
// 
// <summary>
//    Internet Shortcuts custom action code.
// </summary>
//-------------------------------------------------------------------------------------------------
    ...
    )
{
    ...
    while (pwz && *pwz)
    {
        ...
        {
            hr = CreateUrl(pwzTarget, pwzShortcutPath);
        }
        else
        {
            hr = CreateLink(pwzTarget, pwzShortcutPath);
        }
