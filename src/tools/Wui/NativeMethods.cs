...
// 
// <summary>
// Native methods for Isolated Application extension.
// </summary>
//-------------------------------------------------------------------------------------------------
...
namespace Microsoft.Tools.WindowsInstallerXml.Extensions.ClickThrough
{
    ...
    /// <summary>
    /// Native methods for IsolatedApp extension.
    /// </summary>
    internal sealed class NativeMethods
    {
        ...
        [SuppressMessage("Microsoft.Usage", "CA1806:DoNotIgnoreMethodResults", Justification = "What can we do if DestroyIcon fails to destroy the old icon? Nothing - so we'll ignore it.")]
