...
namespace Microsoft.Tools.WindowsInstallerXml.Tools {
    ...
    internal class MeltStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to  usage: melt.exe [-?] [-nologo] {database.msm output.wxs|database.msi output.wixpdb -pdb source.wixpdb} [@responseFile]
        ///
        ...
        ///   -sextract  suppr [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Warning, ProductCode in MSI &apos;{0}&apos; does not match that of the WIXPDB &apos;{1}&apos;..
        /// </summary>
        internal static string WAR_MSIMismatchPDBProductCode {
            get {
                return ResourceManager.GetString("WAR_MSIMismatchPDBProductCode", resourceCulture);
            }
        }
    }
}
