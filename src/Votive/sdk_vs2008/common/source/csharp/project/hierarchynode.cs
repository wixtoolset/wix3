//-------------------------------------------------------------------------------------------------
// <copyright file="hierarchynode.cs" company="Outercurve Foundation">
...
namespace Microsoft.VisualStudio.Package
{
    ...
    //, IVsBuildStatusCallback 
    {
        ...
        protected bool SourceDragged
        {
            get
            {
                return this.sourceDragged;
            }
            set
            {
                this.sourceDragged = value;
            }
        }

        protected List<HierarchyNode> ItemsDraggedOrCutOrCopied
        {
            get
            {
        ...
        public virtual object GetProperty(int propId)
        {
            ...
            switch ((__VSHPROPID)propId)
            {
                ...
                // hierarchyIds should be returned as int by specification
                case __VSHPROPID.VSHPROPID_NextSibling:
                    result = (int)((this.nextSibling != null) ? Utilities.ConvertUIntToInt(this.nextSibling.hierarchyId) : Utilities.ConvertUIntToInt(VSConstants.VSITEMID_NIL));
                    break;
                ...
                case __VSHPROPID.VSHPROPID_FirstVisibleChild:
                    result = (int)((this.firstChild != null) ? Utilities.ConvertUIntToInt(this.firstChild.hierarchyId) : Utilities.ConvertUIntToInt(VSConstants.VSITEMID_NIL));
                    break;

                case __VSHPROPID.VSHPROPID_Parent:
                    if (this.parentNode != null) result = new IntPtr(Utilities.ConvertUIntToInt(this.parentNode.hierarchyId));  // see bug 176470
                    break;
        ...
        /// <summary>
        /// Sends the EXCLUDEFROMPROJECT command to the node.
        /// </summary>
        ...
        public virtual int ParseCanonicalName(string name, out uint itemId)
        {
            ...
            return itemId == 0 ? VSConstants.E_FAIL : VSConstants.S_OK;
        }
