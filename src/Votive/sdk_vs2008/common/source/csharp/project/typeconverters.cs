//-------------------------------------------------------------------------------------------------
// <copyright file="typeconverters.cs" company="Outercurve Foundation">
...
namespace Microsoft.VisualStudio.Package
{
    public class OutputTypeConverter : EnumConverter
    {
        ...
        public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType) {
            if (Utilities.AreTypesEquivalent(sourceType, typeof(string))) return true;
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType) {
            if (Utilities.AreTypesEquivalent(destinationType, typeof(string)))
            {
                string result = null;
