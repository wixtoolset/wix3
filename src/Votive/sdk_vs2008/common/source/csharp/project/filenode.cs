//-------------------------------------------------------------------------------------------------
// <copyright file="filenode.cs" company="Outercurve Foundation">
...
namespace Microsoft.VisualStudio.Package
{
	...
	public class FileNode : HierarchyNode
	{
		...
		protected internal virtual FileNode RenameFileNode(string oldFileName, string newFileName, string linkPath, uint newParentId)
		{
			...
			ErrorHandler.ThrowOnFailure(this.ProjectMgr.AddItemWithSpecific(newParentId, op, VSADDFILEFLAGS.VSADDFILEFLAGS_AddToSourceControlDoneExternally, null, 0, file, IntPtr.Zero, 0, ref emptyGuid, null, ref emptyGuid, result));
