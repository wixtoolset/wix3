//-------------------------------------------------------------------------------------------------
// <copyright file="oafileitem.cs" company="Outercurve Foundation">
		...
		public override EnvDTE.Document Document
		{
			get
			{
				...
				try
				{
					...
					VsShellUtilities.IsDocumentOpen(this.Node.ProjectMgr.Site, this.Node.Url, NativeMethods.LOGVIEWID_Any, out hier, out itemid, out windowFrame);
