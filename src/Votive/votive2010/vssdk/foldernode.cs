//-------------------------------------------------------------------------------------------------
// <copyright file="foldernode.cs" company="Outercurve Foundation">
...
namespace Microsoft.VisualStudio.Package
{
	...
	public class FolderNode : HierarchyNode
	{
		...
		private void RenameFolder(string newName)
		{
			...
			if (String.Compare(Path.GetFileName(VirtualNodeName), newName, StringComparison.OrdinalIgnoreCase) != 0)
			{
